...
--
-- Host: 127.0.0.1
-- Tempo de geração: 22-Abr-2020 às 00:09
...
(1, '1111', 'teste@gmail.com', 'Maria Silva', 1);
...
(1, 'centro', '37490000', 'casa', 'Rua flores', '33', 1, 1),
(2, 'centro', '37490000', 'casa', 'Av primavera', '99', 2, 1);
...
--
-- Estrutura da tabela `pagamento_boleto`
--
...
--
-- Extraindo dados da tabela `pagamento_boleto`
--

INSERT INTO `pagamento_boleto` (`data_pagamento`, `data_vencimento`, `pedido_id`) VALUES
(NULL, '2017-10-10 03:00:00', 2);
...
INSERT INTO `pagamento_cartao` (`numero_parcelas`, `pedido_id`) VALUES
(6, 1);
...
--
-- Índices para tabela `pagamento_boleto`
--
...
--
-- Limitadores para a tabela `pagamento_boleto`
--
ALTER TABLE `pagamento_boleto`
  ADD CONSTRAINT `FKdqk2a6n9it7vodk056daxe4jy` FOREIGN KEY (`pedido_id`) REFERENCES `pagamento` (`pedido_id`);

--
-- Limitadores para a tabela `pagamento_cartao`
--
ALTER TABLE `pagamento_cartao`
  ADD CONSTRAINT `FK936sknk6dwq1oa3p2y7d4s8ol` FOREIGN KEY (`pedido_id`) REFERENCES `pagamento` (`pedido_id`);
