package com.example.curso.exemple.Resources.exception;
...
@ControllerAdvice // isso serve para interceptar a requisição quando der erro então cria uma excessão padrão
